#==============================================================================
# FILENAME: 2b_STHLM3_pred&analysis_weibull.R
# PROJECT: 	STHLM3 PPOS
# PURPOSE: Predicting & analysis (PHASE 2 + 3 of PPOS) with weibull models fitted with brms
...
# Predicted datasets with times and event (censored at maxFU18 + timeadded) -> to analyze with "surv.analysis.RR3"
    ...
    risks_alpha_all <- as.data.frame(do.call(rbind, predicted.surv_w))
